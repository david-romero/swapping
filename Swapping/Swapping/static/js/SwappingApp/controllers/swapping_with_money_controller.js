...
function swapping_with_money_controller_get_swap(id_swap)
{
	jQuery.ajax
	(
		{
			url: "/SwappingApp/swap_with_money/"+id_swap+"/",
			type: 'GET',
			success: function(response)
            {
				swapping_with_money_view_show_swap(response);
            },
            error: function(response)
            {
...
function swapping_with_money_controller_get_images(id_swap)
{
	jQuery.ajax
	(
		{
			url: "/SwappingApp/swap_with_money_photos/"+id_swap+"/",
			type: 'GET',
			data:
			{
				"id_swap": id_swap
			...
			success: function(response)
            {
				swapping_with_money_view_show_swap_photos(response,id_swap);
            },
            error: function(response)
            {
            	display_error_notification('Get Swapping', 'An error occurred. Please try again in a few minutes.', 'fa fa-times');
