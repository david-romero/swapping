					    ...
					    (
					        {
					            ...
					            {
					            	display_success_notification("Success","User created succesfully, please control your email to confirm your subscription",null);
					    ...
					    (
					        {
					            ...
					            {			
					            	...
					            	display_success_notification("Success","User edited succesfully","fa fa-check");
					            	...
					            	setTimeout(function()
					            	{
					            		user_view_show_profile_data(response.id);
					            	}, 3000);
    ...
    (
        {
            ...
            {	
            	jQuery('#figure_loading div').removeClass('spinner');
                display_success_notification("Voted",$('#kvstar-input-21f').val() + " points!","fa fa-check");
...
function user_controller_logged(){
	var result;
	 $.ajax
    (
        {
