...
function administrator_controller_get_all_users()
{
	jQuery('#figure_loading div').addClass('spinner');
	jQuery.ajax
	(
			{
	            ...
	            success: function(response)
	            	{
	            		jQuery('#figure_loading div').removeClass('spinner');
	            		administrator_view_show_users(response);
	            	},
	            error: function(response)
	            {
	            	jQuery('#figure_loading div').removeClass('spinner');
	                console.log(response);
	                display_error('Users','We are sorry, an error has occurred, please try again later...');
	            }
			}
	);
}

function administrator_controller_ban_user(id_user)
{
	...
	(
			{
	            ...
	            success: function(response)
	            	{
	            		jQuery('#figure_loading div').removeClass('spinner');
	            		display_success_notification("Ban User", "The user has been banned", "");
	            		administrator_view_show_ban_user();
	            	},
	            error: function(response)
	            {
	            	jQuery('#figure_loading div').removeClass('spinner');
	                console.log(response);
	                display_error_notification('Ban User','We are sorry, an error has occurred, please try again later...','');
	            }
			}
	);
}

function administrator_controller_unlock_user(id_user)
{
	var user = user_controller_get(id_user, true);
	jQuery('#figure_loading div').addClass('spinner');
	var $csrftoken = $.cookie('csrftoken');
	...
	(
			{
	            ...
	            success: function(response)
	            	{
	            		jQuery('#figure_loading div').removeClass('spinner');
	            		display_success_notification("Unlock User", "The user has been unlocked", "");
	            		administrator_view_show_ban_user();
	            	},
	            error: function(response)
	            {
	            	jQuery('#figure_loading div').removeClass('spinner');
	                console.log(response);
	                display_error_notification('Unlock User','We are sorry, an error has occurred, please try again later...','');
	            }
			}
	);
}